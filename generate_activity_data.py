...
for i, (train_indexes, test_indexes) in enumerate(cv):
    ...
    precision_biking = (conf[2,2]/(sum(conf[:, 2])*1.0))
    recall_walking = (conf[0,0]/(sum(conf[0])*1.0))
    recall_running = (conf[1,1]/(sum(conf[1])*1.0))
    recall_biking =(conf[2,2]/(sum(conf[2])*1.0))
    sum_output = []
    ...
    sum_output.append(precision_biking)
    sum_precision.append(precision_biking)
    ...
    sum_output.append(recall_biking)
    sum_recall.append(recall_biking)
    ...
    print("precision for biking : {}".format(sum_output[3]))
    print("Recall for walking: {}".format(sum_output[4]))
    print("Recall for running: {}".format(sum_output[5]))
    print("Recall for biking: {}".format(sum_output[6]))
    print("\n")
